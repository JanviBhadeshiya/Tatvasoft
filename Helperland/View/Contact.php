            ...
            <form class="cntfm" method="POST" action=<?= $base_url."./?controller=Helperland&function=ContactUs"?>>
              <?php if(isset($_SESSION['message'])){ ?>
                ...
                <div class="form-row part2">
                    <div class="col-md-6 mb-1">
                        <div class="input-group mb-2">
                            ...
                            <input type="text" class="form-control" id="mobilenum" name="PhoneNumber"  placeholder="Mobile Number" maxlength="10" size="10">
                        </div>
                ...
                <div class="form-row dropdowns">
                    <select id="disabledSelect" class="form-control drop" name="Subject">
