        ...
        <div class="contact-form-content mt-5">
          ...
          <div class="r2">
            <select name="Subjects" id="Subjects">
              ...
              <option value="volvo">Subject2</option>
              <option value="volvo">Subject3</option>
            </select>
          </div>
          <div class="r1">
            <input
          ...
          <div class="row">
          <input  class="contact-form-submit mt-5" type="submit" value="submit" name="submit" placeholder="Submit"/>
