...
class HelperlandController
{
    ...
    {
        if (isset($_POST)){
            $base_url = 'http://localhost:8080/Helperland/Contact';
    ...
    public function cSignup()
    {
        ...
        {    
           ...
           $check_mobile_duplicate_count =   $this->model->CheckMobile('user',$_POST['Mobile']);
            ...
            $base_url = "http://localhost:8080/Helperland/#LoginModal'";
            $array = [
                'FirstName' => $_POST['FirstName'],
                'LastName'=>$_POST['LastName'],
                'Email' => $_POST['Email'],
    ...
    public function ForgotPassword()
    {
        if (isset($_POST))
        {
            ...
            if($is_registerd_mail!=0)
            {
                ...
                $body = "click the link t0 reset password <br> http://localhost:8080/Helperland/resetpassword.php";
    ...
    public function Login()
    {
        if (isset($_POST))
        {
            $customer = "http://localhost:8080/Helperland/Customer";
            $sp = "http://localhost:8080/Helperland/SP";
            $admin="http://localhost:8080/Helperland/Admin";
    ...
    public function gotobookservicepage()
    {
        if(isset($_SESSION['loggedin']))
        {
            ...
            {
                $base_url ="http://localhost:8080/Helperland/bookservice";
                header('Location:' . $base_url);
            }
            else
            {
    ...
    {
        $base_url = "http://localhost:8080/Helperland/Faq.php";
        session_unset();
        session_destroy();
        header('Location:' . $base_url);
